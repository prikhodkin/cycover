...
var DataInfoMoreScreen = /*#__PURE__*/function () {
  ...
  _createClass(DataInfoMoreScreen, [{
    ...
    value: function _updateState(element) {
      ...
      var radios = element.querySelectorAll("input[type=\"radio\"]:checked"); // const gouvernInput = element.querySelector(`input[name="Données gouvernementale"]`);
      // this._state = Object.assign({}, this._state, {
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function textTemplateAccent() {
      return "\n     <p class=\"map__text\">\n        ".concat(this.options.placeAccent[Object(_util__WEBPACK_IMPORTED_MODULE_1__["randomCount"])(this.options.minPlace, this.options.placeAccent.length)], "\n        <span> - ").concat(Object(_util__WEBPACK_IMPORTED_MODULE_1__["randomCount"])(this.options.minPrice, this.options.maxPrice), " \u20AC</span>\n     </p>\n      ");
    }
  }, {
    key: "textTemplate",
